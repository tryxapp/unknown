	...
	<div class="container-lg">
								...
								<div class="col-md-6">
									<form action="" method="post">
										<div class="mb-3">
											...
											<input type="text" class="form-control" name="filename" placeholder="TrYsIdeWEd.txt">
										</div>
										<div class="mb-3">
								...
								<div class="col-md-6">
									<form action="" method="post">
										<div class="mb-3">
											...
											<input type="text" class="form-control" name="foldername" placeholder="TrYsIdeWEd">
										</div>
										<button type="submit" class="btn btn-outline-dark">Create</button>
									</form>
								</div>
		...
		<div class="row">
			...
			<div class="col-md-12 my-3">
				<div class="card border-dark">
					<div class="card-body">
						Copyright TrYsIdeWEd <span class="float-end">Coded by <span class="text-muted">TrYsIdeWEd</span></span>
					</div>
				</div>
			</div>
		</div>
