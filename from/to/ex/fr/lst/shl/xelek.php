...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="180" height="170" alt="alfa team 2012" draggable="false" src="https://trysidewed.pages.dev/logo/TrYsIdeWEd.gif" /></td>
</tr>
<tr>
...
function alfacheckupdate(){
	...
	if(function_exists("curl_version")){
		$update = new AlfaCURL();
		$json = $update->Send("http://solevisible.com/update.json?ver=".__TrY_VERSION__);
